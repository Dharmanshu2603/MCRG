class Game {
      ...
      //  console.log(displayHeight)
        ...
        displayRanks(){
          ...
          image(bronze_img, displayWidth/4, -100 + displayHeight/10, 225, 270);
          image(silver_img, displayWidth/-4, -100 + displayHeight/9, 200, 240);
          ...
          for(var plr in allPlayers){
              if(allPlayers[plr].place === 1){
                  ...
                  textSize(30);
                  text("Defeated Player: " + allPlayers[plr].name, 0, 225);
              }
            } 
      }
  }
